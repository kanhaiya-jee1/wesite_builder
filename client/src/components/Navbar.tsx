  ...
  return (
      <>
        ...
        <Link to="/" className='flex items-center'>
          <img src={assets.logo} alt='logo' className='h-6 sm:h-9'/>
          <span className='text-lg sm:text-xl font-bold tracking-tight text-white'>website<span className='text-indigo-500'>builder</span></span>
          </Link>
