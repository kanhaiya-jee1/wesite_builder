...
import { Loader2Icon,  MessageSquareIcon, SmartphoneIcon, TabletIcon, XIcon, LaptopIcon, SaveIcon, FullscreenIcon, ArrowBigDownDashIcon, EyeOffIcon, EyeIcon } from 'lucide-react'
  ...
  return project ? (
    <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
         {/* left*/}
         <div className='flex items-center gap-2 sm:min-w90 text-nowrap'>
          <img src='/favicon.svg' alt='logo' className='h-6 cursor-pointer' onClick={()=> navigate('/')}/>
           ...
           <div className='sm:hidden flex-1 flex justify-end'>
              {isMenuOpen ?
                <MessageSquareIcon onClick={()=> setIsMenuOpen(false)} className='size-6 cursor-pinter' />
